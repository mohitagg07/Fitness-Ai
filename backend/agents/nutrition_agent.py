...
FIXED: accepts local_hour parameter so the "It's X:00" message reflects
the user's local time instead of the server's UTC time.
"""
...
def run_nutrition_agent(
    ...
    # FIXED: use local_hour if provided, else fall back to server time
