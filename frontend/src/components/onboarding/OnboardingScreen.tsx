...
export default function OnboardingScreen() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      actions.setProfile(savedProfile, [], []);
      // Cache onboarding_complete so index.tsx cold-start check works offline
      try {
        const { storage } = require('../../utils/storage');
        await storage.setItem('neurofit_profile', JSON.stringify({ ...savedProfile, onboarding_complete: true }));
      } catch {}
      router.replace('/(tabs)');
    } catch (e: any) {
