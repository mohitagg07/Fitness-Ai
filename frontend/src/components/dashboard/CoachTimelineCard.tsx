// VYRN — Coach Timeline Card
//
// Shows a chronological feed assembled from:
//   personal_records, ai_timeline_events, program_versions
// All real DB data — zero mock content.
...
export default function CoachTimelineCard() {
  ...
  return (
    <View style={styles.card}>
      <View style={styles.header}>
        <Ionicons name="git-branch-outline" size={13} color={COLORS.strainGlow} />
        <Text style={styles.label}>COACH TIMELINE</Text>
      </View>
